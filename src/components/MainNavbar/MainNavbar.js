...
const MainNavbar = () => {
  return (
    <Navbar collapseOnSelect expand="lg" className="bgPrimary" variant="dark">
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="me-auto">
            ...
            >
              ...
              <NavDropdown.Item href="#action/3.3">Classroom</NavDropdown.Item>
              <NavDropdown.Item href="#action/3.4">
                Social Platform
              </NavDropdown.Item>
              <NavDropdown.Item href="#action/3.4">
